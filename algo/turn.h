...
struct turn_r
{
    sign operator () (const primitives::point_2 &a, const primitives::point_2 &b, const primitives::point_2 &c)
    {
        primitives::point_2r ar(a.x, a.y), br(b.x, b.y), cr(c.x, c.y);
        primitives::vector_2r t1 = br - ar;
        primitives::vector_2r t2 = cr - ar;
        auto res = t1 ^ t2;
        if (res > 0)
...
struct turn : public turn_r
{
    sign operator () (const primitives::point_2 &a, const primitives::point_2 &b, const primitives::point_2 &c)
    {
        primitives::vector_2 t1 = b - a;
        primitives::vector_2 t2 = c - a;
        auto res = t1 ^ t2;
